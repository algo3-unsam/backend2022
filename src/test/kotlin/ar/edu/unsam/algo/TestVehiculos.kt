...
class TestVehiculos:DescribeSpec({
    ...
    describe("Test de Vehiculo"){
        describe("Test de Moto"){
            var moto200cc = Moto("honda","ninja",LocalDate.of(2015,7,5),10000.0,250)
            it("Costo Final con Convenio de un alquiler de 3 dias"){
                moto200cc.costoFinal(3) shouldBe 27000
            }
            var motoSinConvenio = Moto("bmw","ninja",LocalDate.of(2015,7,5),10000.0,250)
            it("Costo Final sin Convenio de un alquiler de 3 dias"){
                motoSinConvenio.costoFinal(3) shouldBe 30000
            }
            var moto300cc = Moto("honda","ninja",LocalDate.of(2015,7,5),10000.0,300)
        ...
        describe("Test de Auto"){
            var autoConBaul = Auto("bmw","m3",LocalDate.of(2015,7,5),10000.0, false)
            it("Costo Final por Auto no Hatchback"){
                autoConBaul.costoFinal(3) shouldBe 37500
            }
            var autoSinBaul = Auto("bmw","m10",LocalDate.of(2015,7,5),10000.0, true)
            it("Costo Final por Auto Hatchback"){
                autoSinBaul.costoFinal(3) shouldBe 33000
            }
        }
        describe("Test de Camioneta"){
            var camionetaNormal = Camioneta("bmw","x3",LocalDate.of(2015,7,5),10000.0, false)
            ...
            var camioneta4x4 = Camioneta("bmw","x3",LocalDate.of(2015,7,5),10000.0, true)
            it("Test de Camioneta 4x4"){
                camioneta4x4.costoFinal(10) shouldBe 169500
            }
